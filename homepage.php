            ...
            <div class="a">
                <div class="a1">
                        ...
                        ?>
                            ...
                            <a href="register_form.php"><button class="new user" >New user</button>
                        <?php
                            } else {
                        ?>
                            
                            <a href="dashboard.php"><input type="submit" name="dashboard" value="My Dashboard" class="dashboard"/>
